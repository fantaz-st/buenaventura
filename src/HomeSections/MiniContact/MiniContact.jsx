          ...
          <TheButton href='https://g.co/kgs/Am2SfKF'>
            <div style={{ display: "flex" }}>
              {/*  <svg viewBox='0 0 25 25' fill='none' xmlns='http://www.w3.org/2000/svg'>
                ...
                <g id='SVGRepo_tracerCarrier' strokeLinecap='round' strokeLinejoin='round'></g>
                <g id='SVGRepo_iconCarrier'>
                  <path d='M6.5 10.5C6.5 7 9 4.5 12.5 4.5C16 4.5 18.5 7 18.5 10.5C18.5 14 15.5 17.5 12.5 20.5C9.5 17.5 6.5 14 6.5 10.5Z' stroke='#121923' strokeWidth='1.2'></path>
                  <path d='M14 10.5C14 11.3284 13.3284 12 12.5 12C11.6716 12 11 11.3284 11 10.5C11 9.67157 11.6716 9 12.5 9C13.3284 9 14 9.67157 14 10.5Z' stroke='#121923' strokeWidth='1.2'></path>
                </g>
              </svg> */}
              <p>Obala Hrvatskog narodnog preporoda, Split</p>
            </div>
          </TheButton>
        </div>
      </div>
