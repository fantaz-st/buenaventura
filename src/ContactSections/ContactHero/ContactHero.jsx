  ...
  return (
    <section ref={containerRef} className={classes.container}>
      ...
      <div className={classes.inner}>
        <h1 className={classes.title}>Let’s Get You on the Water</h1>

        <div className={classes.rest}>
          <p className={classes.description}>No‑obligation inquiry: we’re happy to customize routes and timing.</p>
        </div>
      </div>

      <div className={classes.imageContainer}>
        <Image src="/assets/images/boat/rebelde-boats-felix37-above.jpg" alt="Rebelde boats - Felix 37 - Buenaventura" fill className={classes.image} priority sizes="100vw" />
      </div>
    </section>
  );
};
